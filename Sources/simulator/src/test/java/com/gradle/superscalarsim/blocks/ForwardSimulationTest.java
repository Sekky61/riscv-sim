...
public class ForwardSimulationTest
{
  ...
  public void simulate_floatOneRawConflict_usesFullPotentialOfTheProcessor()
  {
    ...
    InputCodeModel ins1 = new InputCodeModelBuilder().hasLoader(initLoader)
                                                     ...
                                                     .hasInstructionName("fsub")
                                                     .hasCodeLine("fsub f5 f4 f5")
                                                     .hasArguments(
                                                         Arrays.asList(argumentAdd1, argumentAdd2, argumentAdd3))
                                                     .build();
    InputCodeModel ins2 = new InputCodeModelBuilder().hasLoader(initLoader)
  ...
  public void simulate_jumpFromLabelToLabel_recordToBTB()
  {
    ...
    InputCodeModel ins1 = new InputCodeModelBuilder().hasLoader(initLoader)
                                                     ...
                                                     .hasArguments(Arrays.asList(argumentJmp1, argumentJmp2))
                                                     .build();
    InputCodeModel label1 = new InputCodeModelBuilder().hasLoader(initLoader)
                                                       ...
                                                       .hasArguments(Arrays.asList(argumentJmp3, argumentJmp4))
                                                       .build();
    InputCodeModel ins2 = new InputCodeModelBuilder().hasLoader(initLoader)
                                                     .hasInstructionFunctionModel(
                                                         this.initLoader.getInstructionFunctionModel("jal"))
    ...
    InputCodeModel ins3 = new InputCodeModelBuilder().hasLoader(initLoader)
                                                     ...
                                                     .hasInstructionTypeEnum(InstructionTypeEnum.kJumpbranch)
                                                     .hasArguments(Arrays.asList(argumentJmp5, argumentJmp6))
                                                     .build();
  ...
  public void simulate_ifElse_executeElseFragment()
  {
    ...
    InputCodeModel ins1 = new InputCodeModelBuilder().hasLoader(initLoader).hasLoader(initLoader).hasInstructionName(
        "beq").hasCodeLine("beq x3 x0 labelIf").hasInstructionTypeEnum(InstructionTypeEnum.kJumpbranch).hasArguments(
        Arrays.asList(argumentJmp1, argumentJmp2, argumentJmp3)).build();
    InputCodeModel ins2 = new InputCodeModelBuilder().hasLoader(initLoader).hasInstructionName("subi").hasCodeLine(
        "subi x1 x1 10").hasInstructionTypeEnum(InstructionTypeEnum.kArithmetic).hasArguments(
    ...
    InputCodeModel ins3 = new InputCodeModelBuilder().hasLoader(initLoader).hasInstructionName("jal").hasCodeLine(
        "jal x0 labelFin").hasInstructionTypeEnum(InstructionTypeEnum.kJumpbranch).hasArguments(
    ...
    InputCodeModel ins4 = new InputCodeModelBuilder().hasLoader(initLoader).hasInstructionName("addi").hasCodeLine(
        "addi x1 x1 10").hasInstructionTypeEnum(InstructionTypeEnum.kArithmetic).hasArguments(
