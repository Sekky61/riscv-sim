...
public class CodeArithmeticInterpreterConstraintsTest
{
  ...
  public void setUp()
  {
    ...
    RegisterFileModel doubleFile = new RegisterFileModelBuilder().hasName("double")
                                                                 ...
                                                                 .hasRegisterList(
                                                                     Arrays.asList(double1, double2, double3))
                                                                 .build();
    
    Mockito.when(initLoader.getRegisterFileModelList()).thenReturn(
        Arrays.asList(integerFile, longFile, floatFile, doubleFile));
