...
public class CacheTest
{
    ...
    public void cache_SplitAddress()
    {
        ...
        cache = new Cache(memory, 16, 2, 16, ReplacementPoliciesEnum.RANDOM, true,
                                true, 1, 1, 1,
    ...
    {
        memory = new SimulatedMemory();
        cache = new Cache(memory, 4, 2, 16, ReplacementPoliciesEnum.LRU, true,
                false, 1, 1, 10,
                new CacheStatisticsCounter()
        );
    ...
    {
        memory = new SimulatedMemory();
        cache = new Cache(memory, 2, 2, 4, ReplacementPoliciesEnum.LRU, true,
                false, 10, 10, 0,
                new CacheStatisticsCounter()
        );
        ...
        //Check memory
        Assert.assertEquals( (byte)0x44, (byte)memory.getFromMemory(0L));
        Assert.assertEquals( (byte)0x33, (byte)memory.getFromMemory(1L));
        Assert.assertEquals( (byte)0x22, (byte)memory.getFromMemory(2L));
        Assert.assertEquals( (byte)0x11, (byte)memory.getFromMemory(3L));
        Assert.assertEquals( (byte)0x88, (byte)memory.getFromMemory(4L));
        Assert.assertEquals( (byte)0x77, (byte)memory.getFromMemory(5L));
        Assert.assertEquals( (byte)0x66, (byte)memory.getFromMemory(6L));
        Assert.assertEquals( (byte)0x55, (byte)memory.getFromMemory(7L));
        Assert.assertEquals( (byte)0x28, (byte)memory.getFromMemory(8L));
        Assert.assertEquals( (byte)0x82, (byte)memory.getFromMemory(9L));
        Assert.assertEquals( (byte)0x19, (byte)memory.getFromMemory(10L));
        Assert.assertEquals( (byte)0x91, (byte)memory.getFromMemory(11L));
        Assert.assertEquals( (byte)0x11, (byte)memory.getFromMemory(12L));
        Assert.assertEquals( (byte)0x44, (byte)memory.getFromMemory(13L));
        Assert.assertEquals( (byte)0x37, (byte)memory.getFromMemory(14L));
        Assert.assertEquals( (byte)0x73, (byte)memory.getFromMemory(15L));
        Assert.assertEquals( (byte)0x66, (byte)memory.getFromMemory(16L));
        Assert.assertEquals( (byte)0x55, (byte)memory.getFromMemory(17L));
        Assert.assertEquals( (byte)0x77, (byte)memory.getFromMemory(18L));
        Assert.assertEquals( (byte)0x33, (byte)memory.getFromMemory(19L));
        Assert.assertEquals( (byte)0x44, (byte)memory.getFromMemory(20L));
        Assert.assertEquals( (byte)0x66, (byte)memory.getFromMemory(21L));
        Assert.assertEquals( (byte)0x99, (byte)memory.getFromMemory(22L));
        Assert.assertEquals( (byte)0x11, (byte)memory.getFromMemory(23L));
        Assert.assertEquals( (byte)0x46, (byte)memory.getFromMemory(24L));
        Assert.assertEquals( (byte)0x13, (byte)memory.getFromMemory(25L));
        Assert.assertEquals( (byte)0x13, (byte)memory.getFromMemory(26L));
        Assert.assertEquals( (byte)0x13, (byte)memory.getFromMemory(27L));
        Assert.assertEquals( (byte)0x64, (byte)memory.getFromMemory(28L));
        Assert.assertEquals( (byte)0x78, (byte)memory.getFromMemory(29L));
        Assert.assertEquals( (byte)0x79, (byte)memory.getFromMemory(30L));
        Assert.assertEquals( (byte)0x98, (byte)memory.getFromMemory(31L));
    }
}
