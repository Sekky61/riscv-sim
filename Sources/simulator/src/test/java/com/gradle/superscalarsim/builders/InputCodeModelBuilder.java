...
public class InputCodeModelBuilder {
    ...
    public InputCodeModel build() {
        ...
        if(this.loader != null) {
            model = this.loader.getInstructionFunctionModelList().stream().filter(
                    instructionFunctionModel -> instructionFunctionModel.getName().equals(
                            this.instructionName)).findFirst().orElse(null);
        } else {
