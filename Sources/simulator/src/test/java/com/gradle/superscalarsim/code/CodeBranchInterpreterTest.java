...
public class CodeBranchInterpreterTest
{
  ...
  public void setUp()
  {
    ...
    this.codeBranchInterpreter = new CodeBranchInterpreter(codeParser, initLoader, new UnifiedRegisterFileBlock(initLoader));
  }
  ...
  public void conditionalJumpEqual_conditionFalse_returnsOne()
  {
    ...
    Assert.assertEquals(false, this.codeBranchInterpreter.interpretInstruction(inputCodeModel,6).isPresent());
  }
  ...
  private List<InputCodeModel> setUpParsedCode()
  {
    ...
    // three:
    // mul x1 x3 x2
    InputCodeModel inputCodeModelLabelOne = new InputCodeModelBuilder().hasLoader(initLoader).hasInstructionName("label")
      .hasCodeLine("one").build();

    InputCodeModel inputCodeModelLabelTwo = new InputCodeModelBuilder().hasLoader(initLoader).hasInstructionName("label")
      .hasCodeLine("two").build();

    InputCodeModel inputCodeModelLabelThree = new InputCodeModelBuilder().hasLoader(initLoader).hasInstructionName("label")
      .hasCodeLine("three").build();
    ...
    return Arrays.asList(
      inputCodeModelLabelOne,
      inputCodeModelAdd,
      inputCodeModelLabelTwo,
      inputCodeModelSub,
      inputCodeModelLabelThree,
      inputCodeModelMul
    );
  }
