...
public class CodeBranchInterpreterTest
{
  ...
  public void unconditionalJump_interpret_returnsJumpDifference()
  {
    ...
    Assert.assertEquals(0, this.codeBranchInterpreter.interpretInstruction(simCodeModel).value().target());
  }
  ...
  public void conditionalJumpEqual_conditionTrue_returnsJumpDifference()
  {
    ...
    Assert.assertEquals(4, this.codeBranchInterpreter.interpretInstruction(simCodeModel).value().target());
  }
  ...
  public void conditionalJumpEqual_conditionFalse_returnsOne()
  {
    ...
    // Should not jump
    Assert.assertFalse(this.codeBranchInterpreter.interpretInstruction(simCodeModel).value().jumpTaken());
  }
  ...
  public void conditionalJumpNotEqual_conditionTrue_returnsJumpDifference()
  {
    ...
    Assert.assertEquals(8, this.codeBranchInterpreter.interpretInstruction(simCodeModel).value().target());
  }
