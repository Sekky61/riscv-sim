...
public class InstructionFunctionModel {
     ...
     */
    public InstructionFunctionModel(String name, InstructionTypeEnum instructionType, String inputDataType,
                                    String outputDataType, String instructionSyntax, String interpretableAs) {
        this.name = name;
