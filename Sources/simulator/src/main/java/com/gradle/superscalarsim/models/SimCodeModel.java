...
public class SimCodeModel implements IInputCodeModel, Comparable<SimCodeModel> {
     ...
     */
    private List<InputCodeArgument> renamedArguments;
     ...
     */
    public SimCodeModel(InstructionFunctionModel instructionFunctionModel, String instructionName, String codeLine, InstructionTypeEnum instructionTypeEnum, DataTypeEnum dataTypeEnum, List<InputCodeArgument> arguments, int id, int instructionBulkNumber) {
