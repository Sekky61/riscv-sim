...
public class CacheAccess
{
     ...
     */
    public CacheAccess(int clockCycle, int endOfReplacement, int id, Boolean[] isHit, boolean isStore, long tag, int index, int offset, long data, Integer[] cacheIndex, Integer[] lineOffset)
    {
     ...
     */
    public CacheAccess(int clockCycle, int endOfReplacement, int id, Boolean[] isHit, boolean isStore, Triplet<Long, Integer, Integer> splitAddress, long data, Integer[] cacheIndex, Integer[] lineOffset)
    {
        this.clockCycle = clockCycle;
        this.endOfReplacement = endOfReplacement;
        this.id = id;
    ...
    public Boolean[] isHit(){ return isHit.toArray(Boolean[]::new); }
    ...
    public Integer[] getCacheIndex(){ return cacheIndex.toArray(Integer[]::new); }
    public Integer[] getLineOffset(){ return lineOffset.toArray(Integer[]::new); }

    public long getData(){ return data; }
    public void setClockCycle(int clockCycle){ this.clockCycle = clockCycle; }

    public void setId(int id){ this.id = id; }

    public void setLoadStore(boolean isStore){ this.isStore = isStore; }

    public void setIsHit(Boolean[] isHit){ this.isHit.addAll(Arrays.asList(isHit)); }
    ...
    public void setCacheIndex(Integer[] cacheIndex){ this.cacheIndex.addAll(Arrays.asList(cacheIndex)); }
    public void setLineOffset(Integer[] lineOffset){ this.lineOffset.addAll(Arrays.asList(lineOffset)); }
    ...
    public int getEndOfReplacement(){ return endOfReplacement; }
}
