...
public class CacheBuilder
{
  ...
  {
    return new Cache(cacheStatisticsCounter, numberOfLines, associativity, lineSize, cache, replacementPolicy, memory,
                     writeBack, cacheLineHistory, cacheIdHistory, lastAccess, storeDelay, loadDelay,
                     lineReplacementDelay, addRemainingDelayToStore, replacementPolicyType, cycleEndOfReplacement);
  }
}