...
pub const CpuConfig = struct {
    ...
    speculativeRegisters: i32,

    /// Core clock frequency in Hz.
    coreClockFrequency: i32,

    /// Cache clock frequency in Hz.
    cacheClockFrequency: i32,
