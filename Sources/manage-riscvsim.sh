...
_arg_certs_path="./certs/"
_arg_domain="localhost"
...
print_help()
{
	...
	printf 'Usage: %s [--base-path <arg>] [--internal-api <arg>] [--external-api <arg>] [--http-port <arg>] [--https-port <arg>] [--certs-path <arg>] [--domain <arg>] [--build-strategy <arg>] [--compose-command <arg>] [-h|--help] [-v|--version] <command>\n' "$0"
	...
	printf '\t%s\n' "--certs-path: Path to SSL certificates directory (default: './certs/')"
	printf '\t%s\n' "--domain: Domain name (for TLS) (default: 'localhost')"
